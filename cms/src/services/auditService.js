...
const ACTIONS = {
    ...
    // v1.40.0: bond coupon actual-amount adjustments, first-coupon-date
    // rescheduling, and the mid-term termination workflow
    INVESTMENT_COUPON_ADJUSTED:          'INVESTMENT_COUPON_ADJUSTED',
    INVESTMENT_COUPON_SCHEDULE_UPDATED:  'INVESTMENT_COUPON_SCHEDULE_UPDATED',
    INVESTMENT_TERMINATION_REQUESTED:    'INVESTMENT_TERMINATION_REQUESTED',
    INVESTMENT_RECORDS_CONFIRMED:        'INVESTMENT_RECORDS_CONFIRMED',
    INVESTMENT_TERMINATED:               'INVESTMENT_TERMINATED',
    INVESTMENT_TERMINATION_REJECTED:     'INVESTMENT_TERMINATION_REJECTED',
    // v1.42.0: bond face-value repayment on the final coupon, automatic
    // maturity completion, and settlement-value auto-funding
    INVESTMENT_PRINCIPAL_REPAID:         'INVESTMENT_PRINCIPAL_REPAID',
    INVESTMENT_COMPLETED_AT_MATURITY:    'INVESTMENT_COMPLETED_AT_MATURITY',
    INVESTMENT_SETTLEMENT_FUNDED:        'INVESTMENT_SETTLEMENT_FUNDED',
    INVESTMENT_SETTLEMENT_VALUE_RECORDED:'INVESTMENT_SETTLEMENT_VALUE_RECORDED',
    ...
    SAVINGS_ENTRY_REVERSED:     'SAVINGS_ENTRY_REVERSED',   // v1.41.0
    SAVINGS_HANDOUT_REVERSED:   'SAVINGS_HANDOUT_REVERSED', // v1.41.0
    ...
    SIDE_FUND_PAYMENT_REVERSED: 'SIDE_FUND_PAYMENT_REVERSED', // v1.41.0
    // FINES & PENALTIES (v1.37.0)
    FINE_ASSIGNED: 'FINE_ASSIGNED',
    FINE_CLEARED:  'FINE_CLEARED',
    // MEMBER DEPOSIT TRACKING (v1.38.0)
    DEPOSIT_CREDITED:              'DEPOSIT_CREDITED',
    DEPOSIT_CONFIG_UPDATED:        'DEPOSIT_CONFIG_UPDATED',
    DEPOSIT_EXCUSAL_SET:           'DEPOSIT_EXCUSAL_SET',
    DEPOSIT_EXCUSAL_CLEARED:       'DEPOSIT_EXCUSAL_CLEARED',
    DEPOSIT_EXIT_REFUND_PROCESSED: 'DEPOSIT_EXIT_REFUND_PROCESSED',
    DEPOSIT_ENTRY_REVERSED:        'DEPOSIT_ENTRY_REVERSED',
    //REQUISITIONS
    ...
    // SIDE FUND — membership checklist & exit payouts (v1.32.0)
    SIDE_FUND_MEMBER_ADDED:            'SIDE_FUND_MEMBER_ADDED',
    SIDE_FUND_MEMBER_REMOVED:          'SIDE_FUND_MEMBER_REMOVED',
    ...
    // PAYMENT CONFIRMATIONS (v1.39.0)
    PAYMENT_CONFIRMATION_CREATED:   'PAYMENT_CONFIRMATION_CREATED',
    PAYMENT_CONFIRMATION_CONFIRMED: 'PAYMENT_CONFIRMATION_CONFIRMED',
    PAYMENT_CONFIRMATION_DISPUTED:  'PAYMENT_CONFIRMATION_DISPUTED',
    PAYMENT_CONFIRMATION_CANCELLED: 'PAYMENT_CONFIRMATION_CANCELLED',
};
