...
- **`blockFinanceRestricted`** — Auditor **and** Administrative Officer. Applied to every other finance-adjacent route file (Accounts, Transactions, Transfers, Grants, Loans, Investments, Requisitions, Savings, Side Fund, Fines, Dividends, Reports, Search, Shares, Certificates, Exchange Rates, System, `/users/shareholding`).
...
| `REACT_APP_VERSION` | `1.37.0` | `1.37.0` (kept in sync manually — a pure display string, nothing reads it programmatically) |
