...
const ACTIONS = {
    ...
    CAPITAL_GOAL_CALL_PLEDGE_SUBMITTED: 'CAPITAL_GOAL_CALL_PLEDGE_SUBMITTED',
    CAPITAL_GOAL_CALL_PLEDGE_EDITED:    'CAPITAL_GOAL_CALL_PLEDGE_EDITED',
    CAPITAL_GOAL_CALL_PLEDGE_REJECTED:  'CAPITAL_GOAL_CALL_PLEDGE_REJECTED',
    CAPITAL_GOAL_CALL_PAYMENT_APPROVED: 'CAPITAL_GOAL_CALL_PAYMENT_APPROVED',
    CAPITAL_GOAL_CALL_FINE_ASSIGNED:    'CAPITAL_GOAL_CALL_FINE_ASSIGNED',
    CAPITAL_GOAL_CALL_ITERATION2_OPENED:'CAPITAL_GOAL_CALL_ITERATION2_OPENED',
    // Events
    ...
    // SERVICE FEE MONTHLY PERIOD TRACKING (v1.52.0)
    SERVICE_FEE_PERIOD_OVERRIDE_SET: 'SERVICE_FEE_PERIOD_OVERRIDE_SET',
    SERVICE_FEE_MONTHS_SETTLED:      'SERVICE_FEE_MONTHS_SETTLED',
    SERVICE_FEE_DUE_REMINDER_SENT:   'SERVICE_FEE_DUE_REMINDER_SENT',
    // SERVICE FEE SELF-SERVICE PAYMENT REQUESTS & ADVANCES (v1.53.0)
    SERVICE_FEE_PAYMENT_REQUESTED:        'SERVICE_FEE_PAYMENT_REQUESTED',
    SERVICE_FEE_PAYMENT_REQUEST_APPROVED: 'SERVICE_FEE_PAYMENT_REQUEST_APPROVED',
    SERVICE_FEE_PAYMENT_REQUEST_REJECTED: 'SERVICE_FEE_PAYMENT_REQUEST_REJECTED',
    SERVICE_FEE_ADVANCE_REQUESTED:        'SERVICE_FEE_ADVANCE_REQUESTED',
    SERVICE_FEE_ADVANCE_APPROVED:         'SERVICE_FEE_ADVANCE_APPROVED',
    SERVICE_FEE_ADVANCE_REJECTED:         'SERVICE_FEE_ADVANCE_REJECTED',
    // SERVICE FEE PERIOD EXCLUSIONS (v1.54.0)
    SERVICE_FEE_PERIOD_EXCLUDED: 'SERVICE_FEE_PERIOD_EXCLUDED',
    SERVICE_FEE_PERIOD_INCLUDED: 'SERVICE_FEE_PERIOD_INCLUDED',
